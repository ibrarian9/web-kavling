...
## Corpus Check
- 484 files · ~237,206 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2012 nodes · 3746 edges · 357 communities (223 shown, 134 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 628 edges (avg confidence: 0.8)
...
## Communities (357 total, 134 thin omitted)
...
### Community 207 - "User"
Cohesion: 0.06
Nodes (9): Index, User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Spatie\Permission\Traits\HasRoles, BookingRejectionAndHppVisibilityTest, CashflowSeparationAndExportTest, InactiveAccountLoginTest (+1 more)
...
Cohesion: 0.09
Nodes (6): ConvertInstallmentToCashAction, DeleteInstallmentSchemeAction, CashflowTransaction, InstallmentPayment, CascadeDeletionService, CashflowSyncAndDeleteTest
...
Cohesion: 0.09
Nodes (5): Show, ExternalProject, ExternalProjectMaterial, ExternalProjectWorkerWage, ExternalProjectsModuleTest
...
### Community 261 - "WorkerUnitPayroll"
Cohesion: 0.13
...
- **Why does `User` connect `User` to `Index`, `Index`, `Project.php`, `Booking`, `Index`, `.canViewSalesPrices`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Illuminate\Http\Request`, `Index`, `WorkerAssignment`, `UnitInstallment.php`, `Livewire\Component`, `CompanyReceivable`, `DailyActivityReport`, `ActivityLogger`, `Unit`, `Project`, `AllPagesTest`, `BulkMaterialPurchaseTest`, `EmployeePayrollPayment`, `.run`, `ContractorAndInstallmentCancellationTest`, `AuditAllButtonsTest`, `CashflowTransaction`, `UnitDetailResponsivenessAndRoleTest`, `AdminPriceRestrictionsAndUnitExpensesTest`, `User.php`, `ActivityLog`, `AdminRoleCrudTest`, `ExternalProject`, `GlobalSearchTest`, `OfficialDocument`, `ActivityLogTest`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Unit` connect `Unit` to `LegacySale`, `Unit.php`, `Index`, `WorkerUnitPayroll`, `Index`, `Booking`, `Index`, `.exportPdf`, `Project.php`, `Show`, `Index`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `WorkerAssignment`, `UnitInstallment.php`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `CompanyReceivable`, `Index`, `DailyActivityReport`, `WorkerSalaryPayment`, `Project`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Index`, `.exportPdf`, `ProjectReportController`, `ProjectPayment`, `AllPagesTest`, `BulkMaterialPurchaseTest`, `EmployeeSalary`, `.run`, `ContractorAndInstallmentCancellationTest`, `.canManageFinancial`, `User`, `CashflowTransaction`, `UnitDetailResponsivenessAndRoleTest`, `AdminPriceRestrictionsAndUnitExpensesTest`, `AdminRoleCrudTest`, `Show`, `UnitInstallment`, `.render`, `GlobalSearchTest`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `LegacySale`, `Project.php`, `Booking`, `Index`, `.exportPdf`, `Index`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Illuminate\Http\Request`, `WorkerAssignment`, `UnitInstallment.php`, `CompanyReceivable`, `DailyActivityReport`, `Unit`, `WorkerSalaryPayment`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Index`, `.exportPdf`, `ProjectReportController`, `ProjectPayment`, `AllPagesTest`, `UnpaidInstallmentReportController`, `EmployeeSalary`, `.run`, `User`, `CashflowTransaction`, `UnitDetailResponsivenessAndRoleTest`, `AdminPriceRestrictionsAndUnitExpensesTest`, `OrphanCashflowAuditor.php`, `AdminRoleCrudTest`, `Show`, `.render`, `GlobalSearchTest`, `.execute`, `Index`?**
