# Graph Report - web-kavling  (2026-08-27)

## Corpus Check
- 484 files · ~236,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2010 nodes · 3739 edges · 348 communities (223 shown, 125 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 624 edges (avg confidence: 0.8)
...
- AdminPriceRestrictionsAndUnitExpensesTest
...
- Index
- ProjectPayment
- ExternalProjectReportController
- .run
...
5. `Show` - 75 edges
6. `WorkerUnitPayroll` - 50 edges
7. `TestCase` - 43 edges
8. `Index` - 40 edges
9. `Index` - 40 edges
10. `UnitInstallment` - 36 edges
...
### Community 7 - "Booking"
Cohesion: 0.06
Nodes (4): Index, Index, Booking, me_date()
...
### Community 12 - "WithDatePeriodFilter.php"
Cohesion: 0.06
Nodes (6): ManualInvoiceController, Index, Index, ManualInvoice, applyDatePeriodFilter(), Illuminate\Database\Eloquent\Builder
...
Cohesion: 0.18
Nodes (4): AuthController, DailyActivityReportPdfController, UnpaidInstallmentReportController, Illuminate\Http\Request
...
### Community 45 - "Unit"
Cohesion: 0.10
Nodes (3): Unit, Illuminate\Database\Eloquent\Relations\HasOne, AdminRoleCrudTest
...
Cohesion: 0.10
Nodes (4): CashflowTransaction, InstallmentPayment, CascadeDeletionService, CashflowSyncAndDeleteTest
...
### Community 227 - "ActivityLogger"
Cohesion: 0.06
Nodes (8): Index, Show, Index, ExternalProject, ExternalProjectMaterial, ExternalProjectWorkerWage, ActivityLogger, ExternalProjectsModuleTest
...
### Community 253 - "WorkerAssignment"
Cohesion: 0.12
...
### Community 300 - "EnsureUserIsActive.php"
Cohesion: 0.60
Nodes (3): EnsureUserIsActive, Closure, Symfony\Component\HttpFoundation\Response

### Community 302 - "Project"
Cohesion: 0.09
Nodes (7): CashflowVerificationController, ProjectReportController, Project, AllPagesTest, GlobalSearchTest, createTestProjectForValidation(), SystemE2ESuiteTest

### Community 327 - "WeeklyMaterialPurchase"
Cohesion: 0.07
...
### Community 341 - "EmployeePayrollPayment"
Cohesion: 0.20
...
- **Why does `Unit` connect `Unit` to `LegacySale`, `Project.php`, `Index`, `Index`, `Booking`, `DailyActivityReport`, `.exportPdf`, `Show`, `WithDatePeriodFilter.php`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Index`, `AdminPriceRestrictionsAndUnitExpensesTest`, `CashflowTransaction.php`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Index`, `UniqueUnitCodeTest`, `.render`, `Project`, `BookingRejectionAndHppVisibilityTest`, `Illuminate\Database\Eloquent\Relations\HasMany`, `.exportPdf`, `ProjectPayment`, `BulkMaterialPurchaseTest`, `WeeklyMaterialPurchase`, `.run`, `ContractorAndInstallmentCancellationTest`, `User`, `CashflowTransaction`, `UnitDetailResponsivenessAndRoleTest`, `.render`, `Show`, `UnitInstallment`, `WorkerAssignment`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Index`, `Index`, `Booking`, `DailyActivityReport`, `.canViewSalesPrices`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Illuminate\Http\Request`, `Index`, `AdminPriceRestrictionsAndUnitExpensesTest`, `CashflowTransaction.php`, `Livewire\Component`, `UniqueUnitCodeTest`, `.render`, `Unit`, `Project`, `BookingRejectionAndHppVisibilityTest`, `Index`, `.run`, `BulkMaterialPurchaseTest`, `WeeklyMaterialPurchase`, `.run`, `ContractorAndInstallmentCancellationTest`, `InactiveAccountLoginTest`, `AuditAllButtonsTest`, `CashflowTransaction`, `UnitDetailResponsivenessAndRoleTest`, `EmployeePayrollPayment`, `User.php`, `ActivityLog`, `ActivityLogger`, `OfficialDocument`, `ActivityLogTest`, `WorkerAssignment`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `LegacySale`, `Project.php`, `Booking`, `DailyActivityReport`, `.exportPdf`, `WithDatePeriodFilter.php`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Illuminate\Http\Request`, `Index`, `AdminPriceRestrictionsAndUnitExpensesTest`, `CashflowTransaction.php`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `.render`, `Unit`, `BookingRejectionAndHppVisibilityTest`, `Illuminate\Database\Eloquent\Relations\HasMany`, `.exportPdf`, `ProjectPayment`, `WeeklyMaterialPurchase`, `.run`, `User`, `CashflowTransaction`, `UnitDetailResponsivenessAndRoleTest`, `OrphanCashflowAuditor.php`, `.render`, `Show`, `.execute`, `WorkerAssignment`?**
