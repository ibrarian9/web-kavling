...
## Corpus Check
- 440 files · ~198,188 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1810 nodes · 3270 edges · 320 communities (202 shown, 118 thin omitted)
...
### Community 6 - "Project"
Cohesion: 0.05
Nodes (8): ProjectReportController, Index, Index, Project, WorkerAssignment, AdminRoleCrudTest, createTestProjectForValidation(), SystemE2ESuiteTest
...
### Community 24 - "CashflowTransaction.php"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (9): DatabaseSeeder, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, ContractorAndInstallmentCancellationTest, GlobalSearchTest, InactiveAccountLoginTest, OfficialDocumentSearchFilterTest, PengawasManagementTest (+1 more)
...
Cohesion: 0.14
Nodes (11): BookingSeeder, DailyActivityReportSeeder, FinancialSeeder, OfficialDocumentSeeder, PayablesAndReceivablesSeeder, PriceProposalSeeder, ProductionSeeder, ProjectSeeder (+3 more)
...
Cohesion: 0.12
Nodes (4): ConvertInstallmentToCashAction, DeleteInstallmentPaymentAction, SetupInstallmentSchemeAction, UnitInstallment

### Community 229 - "ActivityLog"
Cohesion: 0.10
...
- **Why does `Unit` connect `Unit` to `OfficialDocument`, `LegacySale`, `InstallmentPayment`, `User.php`, `Index`, `Index`, `Project`, `Show`, `DailyActivityReport`, `BookingRejectionAndHppVisibilityTest.php`, `PriceProposal`, `Show`, `Index`, `UnitInstallment.php`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Index`, `Index`, `Index`, `ProjectPayment`, `CompanyReceivable`, `Illuminate\Foundation\Testing\RefreshDatabase`, `WorkerSalaryPayment`, `AllPagesTest.php`, `ActivityLogger`, `Booking`, `Controller`, `UniqueUnitCodeTest.php`, `UnitDetailResponsivenessAndRoleTest.php`, `.exportPdf`, `User`, `CashflowTransaction`, `.exportPdf`, `UnitInstallment`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `CashflowSeparationAndExportTest`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `OfficialDocument`, `User.php`, `InstallmentPayment`, `Index`, `Project`, `DailyActivityReport`, `BookingRejectionAndHppVisibilityTest.php`, `PriceProposal`, `Show`, `UnitInstallment.php`, `Illuminate\Http\Request`, `Index`, `CompanyReceivable`, `Illuminate\Foundation\Testing\RefreshDatabase`, `AllPagesTest.php`, `ActivityLogger`, `Booking`, `UniqueUnitCodeTest.php`, `UnitDetailResponsivenessAndRoleTest.php`, `CashflowTransaction`, `ActivityLog`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `CashflowSeparationAndExportTest`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `OfficialDocument`, `LegacySale`, `User.php`, `Show`, `DailyActivityReport`, `BookingRejectionAndHppVisibilityTest.php`, `PriceProposal`, `Index`, `UnitInstallment.php`, `Illuminate\Http\Request`, `Index`, `Index`, `ProjectPayment`, `CompanyReceivable`, `Illuminate\Foundation\Testing\RefreshDatabase`, `AllPagesTest.php`, `.execute`, `ActivityLogger`, `Booking`, `Controller`, `UnpaidInstallmentReportController`, `UnitDetailResponsivenessAndRoleTest.php`, `.exportPdf`, `User`, `CashflowTransaction`, `OrphanCashflowAuditor.php`, `.exportPdf`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `CashflowSeparationAndExportTest`?**
