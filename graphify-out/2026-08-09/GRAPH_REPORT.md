...
## Corpus Check
- 334 files · ~159,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1384 nodes · 2384 edges · 224 communities (148 shown, 76 thin omitted)
...
### Community 15 - "User"
Cohesion: 0.09
Nodes (6): User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Spatie\Permission\Traits\HasRoles, ActivityLogTest, CashflowSeparationAndExportTest
...
Cohesion: 0.16
Nodes (4): Index, ActivityLog, Livewire\Component, Livewire\WithPagination
...
- **Why does `Unit` connect `Unit` to `User.php`, `Controller`, `Project`, `Index`, `Show`, `Index`, `WorkerSalaryPayment`, `Show`, `Index`, `User`, `Booking`, `Index`, `Index`, `LegacySale`, `CashflowTransaction`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Illuminate\Database\Eloquent\Relations\HasMany`, `WeeklyMaterialPurchase`, `.exportPdf`, `.render`, `UnitDetailResponsivenessAndRoleTest`, `ContractorAndInstallmentCancellationTest`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `User.php`, `Controller`, `Project`, `Index`, `Index`, `Index`, `Unit`, `Booking`, `WeeklyMaterialPurchase`, `EmployeePayrollPayment`, `ContractorAndInstallmentCancellationTest`, `OfficialDocument`, `CashflowTransaction`, `Index`, `Livewire\Component`, `UnitDetailResponsivenessAndRoleTest`, `ActivityLogger`, `InactiveAccountLoginTest`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `User.php`, `Controller`, `Show`, `Index`, `WorkerSalaryPayment`, `Index`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Booking`, `Index`, `WeeklyMaterialPurchase`, `Index`, `.exportPdf`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `LegacySale`, `CashflowTransaction`, `User`, `.render`, `UnitDetailResponsivenessAndRoleTest`?**
