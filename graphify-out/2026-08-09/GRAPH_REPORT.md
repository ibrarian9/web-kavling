...
## Corpus Check
- 331 files · ~158,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1371 nodes · 2360 edges · 224 communities (152 shown, 72 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 376 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f7b935b`
...
## Communities (224 total, 72 thin omitted)

### Community 0 - "User.php"
Cohesion: 0.06
Nodes (9): Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Model, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, CashflowSeparationAndExportTest, ContractorAndInstallmentCancellationTest, GlobalSearchTest, OfficialDocumentSearchFilterTest (+1 more)
...
### Community 15 - "User"
Cohesion: 0.09
Nodes (6): Index, User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Spatie\Permission\Traits\HasRoles, UniqueUnitCodeTest
...
Cohesion: 0.12
Nodes (10): BookingSeeder, me_date(), DatabaseSeeder, FinancialSeeder, ProductionSeeder, ProjectSeeder, UnitSeeder, UserSeeder (+2 more)
...
### Community 21 - "OfficialDocument"
Cohesion: 0.13
Nodes (3): GlobalSearch, OfficialDocument, OfficialDocumentSeeder
...
Cohesion: 0.13
Nodes (5): Index, Dashboard, Index, Livewire\Component, Livewire\WithPagination
...
- **Why does `Unit` connect `Unit` to `User.php`, `Project`, `Index`, `Show`, `Index`, `WeeklyMaterialPurchase`, `Show`, `Index`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Booking`, `User`, `Illuminate\Database\Seeder`, `OfficialDocument`, `CashflowTransaction`, `LegacySale`, `UnitDetailResponsivenessAndRoleTest`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `User.php`, `Illuminate\Http\Request`, `Project`, `Index`, `Index`, `Index`, `WeeklyMaterialPurchase`, `Show`, `Unit`, `Booking`, `Illuminate\Database\Seeder`, `OfficialDocument`, `ActivityLogger`, `Index`, `Index`, `InactiveAccountLoginTest`, `EmployeePayrollPayment`, `EmployeeSalaries/Index.php`, `UnitDetailResponsivenessAndRoleTest`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `User.php`, `Show`, `Index`, `WeeklyMaterialPurchase`, `Index`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Unit`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Booking`, `Index`, `Illuminate\Database\Seeder`, `OfficialDocument`, `CashflowTransaction`, `LegacySale`, `UnitDetailResponsivenessAndRoleTest`, `UnpaidInstallmentReportController`?**
