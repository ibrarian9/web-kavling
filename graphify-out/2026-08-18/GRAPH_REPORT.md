# Graph Report - web-kavling  (2026-08-18)

## Corpus Check
- 458 files · ~206,267 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1863 nodes · 3364 edges · 337 communities (212 shown, 125 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 535 edges (avg confidence: 0.8)
...
Cohesion: 0.07
Nodes (5): ManualInvoiceController, Index, ManualInvoice, applyDatePeriodFilter(), Illuminate\Database\Eloquent\Builder
...
### Community 45 - "Unit"
Cohesion: 0.11
Nodes (4): Unit, Illuminate\Database\Eloquent\Relations\HasOne, AdminRoleCrudTest, CashflowSyncAndDeleteTest
...
### Community 207 - "User"
Cohesion: 0.09
Nodes (7): User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Spatie\Permission\Traits\HasRoles, BookingRejectionAndHppVisibilityTest, CashflowSeparationAndExportTest, InactiveAccountLoginTest
...
Cohesion: 0.15
Nodes (3): CashflowTransaction, WorkerSalaryPayment, CascadeDeletionService
...
### Community 220 - "Illuminate\Database\Seeder"
Cohesion: 0.11
...
Cohesion: 0.18
Nodes (5): CashflowVerificationController, Controller, EmployeeSalarySlipController, ReceiptVerificationController, Illuminate\Http\Response
...
### Community 325 - "EnsureUserIsActive.php"
Cohesion: 0.60
...
## Knowledge Gaps
- **436 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+431 more)
...
- **Why does `Unit` connect `Unit` to `LegacySale`, `Index`, `ProjectReportController`, `Index`, `Show`, `DailyActivityReport`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Show`, `WithDatePeriodFilter.php`, `WorkerUnitPayroll`, `Index`, `Index`, `ProjectPayment`, `ContractorAndInstallmentCancellationTest`, `Index`, `CompanyReceivable`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Booking`, `Project`, `Illuminate\Database\Eloquent\Relations\HasMany`, `WeeklyMaterialPurchase`, `UniqueUnitCodeTest`, `.exportPdf`, `.exportPdf`, `AllPagesTest`, `UnitDetailResponsivenessAndRoleTest`, `.render`, `User`, `GlobalSearchTest`, `CashflowTransaction`, `Unit.php`, `.run`, `UnitInstallment`, `Controller`, `OfficialDocument`, `WorkerAssignment`, `UnitInstallment.php`, `InstallmentPayment`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Index`, `Index`, `User.php`, `DailyActivityReport`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `Show`, `Livewire\Component`, `Illuminate\Http\Request`, `Index`, `ActivityLog`, `ContractorAndInstallmentCancellationTest`, `CompanyReceivable`, `ActivityLogTest`, `Booking`, `Project`, `Unit`, `WeeklyMaterialPurchase`, `UniqueUnitCodeTest`, `Index`, `AllPagesTest`, `UnitDetailResponsivenessAndRoleTest`, `PengawasManagementTest`, `GlobalSearchTest`, `.run`, `ActivityLogger`, `OfficialDocument`, `UnitInstallment.php`, `InstallmentPayment`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `LegacySale`, `Project.php`, `ProjectReportController`, `Show`, `DailyActivityReport`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `PriceProposal`, `WithDatePeriodFilter.php`, `Illuminate\Http\Request`, `Index`, `ProjectPayment`, `Index`, `CompanyReceivable`, `Booking`, `Unit`, `Illuminate\Database\Eloquent\Relations\HasMany`, `WeeklyMaterialPurchase`, `.exportPdf`, `.exportPdf`, `UnpaidInstallmentReportController`, `.execute`, `AllPagesTest`, `UnitDetailResponsivenessAndRoleTest`, `.render`, `PengawasManagementTest`, `User`, `GlobalSearchTest`, `OrphanCashflowAuditor.php`, `.run`, `Controller`, `OfficialDocument`, `WorkerAssignment`, `UnitInstallment.php`?**
