...
use App\Livewire\Costs\Index as CostsIndex;
...
use App\Livewire\Materials\WeeklyLog as WeeklyLogIndex;
use App\Livewire\Workers\Assignments as WorkerAssignmentsIndex;
use App\Livewire\Workers\Index as WorkersIndex;
use App\Livewire\Workers\Loans as WorkerLoansIndex;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/worker-assignments', WorkerAssignmentsIndex::class)->name('workers.assignments');
    Route::get('/worker-loans', WorkerLoansIndex::class)->name('workers.loans');
    Route::get('/weekly-log', WeeklyLogIndex::class)->name('materials.weekly-log');
