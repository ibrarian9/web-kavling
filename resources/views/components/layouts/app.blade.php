        ...
        <aside class="w-64 bg-slate-900 border-r border-slate-800 text-slate-300 flex flex-col justify-between shrink-0 hidden md:flex">
            <div>
                ...
                <nav class="p-4 space-y-1 text-sm overflow-y-auto max-h-[calc(100vh-220px)]">
                    ...
                    <a href="{{ route('tutorial.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium transition {{ request()->routeIs('tutorial.*') ? 'bg-amber-500/10 text-amber-400 border-r-2 border-amber-500' : 'hover:bg-slate-800 text-slate-400 hover:text-slate-200' }}">
                        ...
                        <span class="font-bold text-amber-300">Tutorial System</span>
                    </a>
                    ...
                    @if($isF)
                        ...
                        <a href="{{ route('profile.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium transition {{ request()->routeIs('profile.*') ? 'bg-emerald-500/10 text-emerald-400 border-r-2 border-emerald-500' : 'hover:bg-slate-800 text-slate-400 hover:text-slate-200' }}">
                            <svg class="w-5 h-5 shrink-0 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
        ...
        <aside x-show="mobileMenuOpen" 
            ...
            <div>
                ...
                <nav class="p-4 space-y-1 text-sm">
                    ...
                    <a href="{{ route('tutorial.index') }}" @click="mobileMenuOpen = false" class="flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium transition {{ request()->routeIs('tutorial.*') ? 'bg-amber-500/10 text-amber-400 border-r-2 border-amber-500' : 'hover:bg-slate-800 text-slate-400 hover:text-slate-200' }}">
                        <svg class="w-5 h-5 shrink-0 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                        <span class="font-bold text-amber-300">Tutorial System</span>
                    </a>
