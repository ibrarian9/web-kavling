...
<aside x-show="sidebarOpen"
       ...
       class="w-64 bg-slate-900 border-r border-slate-800/80 text-slate-300 flex flex-col justify-between shrink-0 hidden md:flex shadow-xl">
    <div>
        <!-- Brand Header -->
        <div class="h-16 px-5 flex items-center justify-between border-b border-slate-800/80 bg-slate-950/40">
            ...
            <button @click="sidebarOpen = false" class="text-slate-400 hover:text-white p-1.5 rounded-lg hover:bg-slate-800 transition focus:outline-none" title="Sembunyikan Sidebar">
                ✕
            </button>
        </div>
