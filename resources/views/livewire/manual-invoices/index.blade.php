                        ...
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-1.5">
                                    ...
                                    <button wire:click="deleteInvoice({{ $inv->id }})" wire:confirm="Yakin ingin menghapus invoice manual ini beserta mutasi arus kas terkait?" class="btn-action-delete" title="Hapus Invoice">
