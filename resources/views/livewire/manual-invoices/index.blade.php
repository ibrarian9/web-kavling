                        ...
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-1.5">
                                    <button wire:click="openPdfPreview('{{ $inv->uuid }}')" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-teal-50 text-teal-800 hover:bg-teal-100 border border-teal-200 text-[11px] font-bold transition" title="Pratinjau Invoice PDF">
                                        <svg class="w-3.5 h-3.5 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                                        PDF
                                    </button>

                                    <button wire:click="editInvoice({{ $inv->id }})" class="p-1 text-slate-400 hover:text-amber-600 rounded transition" title="Edit Invoice">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                    </button>

                                    <button wire:click="deleteInvoice({{ $inv->id }})" wire:confirm="Yakin ingin menghapus invoice manual ini beserta mutasi arus kas terkait?" class="p-1 text-slate-400 hover:text-rose-600 rounded transition" title="Hapus Invoice">
