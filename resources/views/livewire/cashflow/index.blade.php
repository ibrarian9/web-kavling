                            ...
                            <td class="px-5 py-4 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-1.5 flex-wrap">
                                    @if ($trx->receipt_photo_url)
                                        <button wire:click="openImageModal('{{ $trx->receipt_photo_url }}', 'Foto Struk Resi Kas - {{ $trx->description }}')" class="btn-action-pdf bg-amber-50 text-amber-800 border-amber-200 hover:bg-amber-100" title="Buka Foto Struk Bukti Transfer / Transaksi">
                                    ...
                                    @if(auth()->user()->isFounder())
                                        <button type="button" @click="confirmModalAction({
                                         ...
                                         })" class="btn-action-delete" title="Hapus Transaksi Kas">
