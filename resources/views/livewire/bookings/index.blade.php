                    ...
                    @forelse ($bookings as $b)
                        <tr class="hover:bg-slate-50/60 transition-colors">
                            ...
                            <td class="px-5 py-4 text-right whitespace-nowrap space-x-1">
                                ...
                                <a href="{{ route('bookings.receipt', $b->id) }}" target="_blank" class="px-2.5 py-1.5 bg-teal-50 hover:bg-teal-100 text-teal-700 rounded-lg text-xs font-semibold border border-teal-200 inline-flex items-center gap-1 shadow-sm">
                                    <svg class="w-3.5 h-3.5 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                    <span>Unduh Invoice Pembayaran</span>
                                </a>
                            </td>
                        </tr>
                    @empty
