...
@if($showLegacyModal)
    <x-modal-dialog show="showLegacyModal" 
                    closeAction="closeLegacyModal" 
                    title="Input Penjualan Lalu" 
                    subTitle="Proyek: {{ $project->name }} (Historis Lunas 100%)" 
                    maxWidth="max-w-2xl">
        <form wire:submit.prevent="submitLegacySale" class="space-y-4 text-xs">
            ...
            <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <select wire:model.live="legacy_category" class="select-clean w-full font-semibold">
            ...
            <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        <x-currency-input 
                            label="Harga Jual Deal (Lunas)" 
                            model="legacy_final_selling_price" 
                            :value="$legacy_final_selling_price"
                            placeholder="0"
                            badgeColor="emerald"
                            required 
                        />
            ...
            <div class="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <select wire:model="legacy_payment_method" class="select-clean w-full font-semibold">
            ...
            <div class="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-3 pt-3 border-t border-slate-100">
                <x-button type="button" variant="secondary" wire:click="closeLegacyModal">Batal</x-button>
                <x-button type="submit" variant="purple" loadingTarget="submitLegacySale">Simpan Penjualan Masa Lalu</x-button>
            </div>
        </form>
    </x-modal-dialog>
@endif
